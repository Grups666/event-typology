...
The fixed background is a faded NASA Blue Marble satellite composite with
topography/bathymetry shading and Natural Earth land national boundaries.
No coastline outlines or land-fill polygons are drawn. The background source
is documented in `assets/blue-marble-source.md`.
